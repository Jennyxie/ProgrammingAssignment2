...
## The second function "cacheSolve" computes the inverse of the speicla "matrix" created by makeCacheMatrix above. 
## If the inverse has alrady been calculated from the cache, it returns the cached inverse.
